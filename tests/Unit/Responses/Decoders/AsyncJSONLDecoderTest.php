...
class AsyncJSONLDecoderTest extends TestCase
{
    ...
    public function testDecodeMultipleLines(): void
    {
        ...
        $decoder = new AsyncJSONLDecoder($iterator, 'array', $this->mockResponse);

        $items = iterator_to_array($decoder->decode());
    ...
    public function testDecodeBatchResultFormat(): void
    {
        ...
        $jsonLines = [
            ...
            '{"custom_id": "request_2", "result": {"type": "succeeded"}}' . "\n",
        ];
        $iterator = new \ArrayIterator($jsonLines);
    ...
    public function testInvalidJsonThrowsException(): void
    {
        ...
        iterator_to_array($decoder->decode());
    }
}
