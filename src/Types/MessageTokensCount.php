...
class MessageTokensCount
{
     ...
     * @param int|null $cache_creation_input_tokens Tokens used creating cache
     * @param int|null $cache_read_input_tokens Tokens saved via cache reads
     * @param array<string, mixed>|null $context_management Extra metadata when context edits are applied
     */
