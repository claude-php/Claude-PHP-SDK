...
/**
 * Code execution result block parameter (for constructing tool results in follow-up messages).
 */
class CodeExecutionResultBlockParam
{
    /**
     * @param CodeExecutionOutputBlockParam[] $content     File outputs produced during execution
