...
/**
 * Beta code execution result block parameter (for tool result messages).
 */
class BetaCodeExecutionResultBlockParam
{
    /**
     * @param BetaCodeExecutionOutputBlockParam[] $content     File outputs produced during execution
