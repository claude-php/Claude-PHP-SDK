...
/**
 * Code execution tool parameter (version 2025-08-25).
 *
 * Enhanced code execution tool with improved sandbox capabilities.
 * Use type "code_execution_20250825" in your tool definition.
 *
 * @see https://docs.anthropic.com/en/docs/build-with-claude/tool-use/code-execution
 */
class CodeExecutionTool20250825Param
{
    /**
     * @param string      $name             Must be "code_execution"
     * @param string      $type             Must be "code_execution_20250825"
    ...
    public function __construct(
        ...
        public readonly string $type = 'code_execution_20250825',
